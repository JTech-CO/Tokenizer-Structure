...
// 기준일: 2026-07-23 (가격은 수시 변동 — 실제 청구 전 각 공식 페이지 재확인)
// 단위: USD per 1,000,000 tokens (input/output 분리)
// 출처:
//   OpenAI    — developers.openai.com/api/docs/pricing (GPT-5.6 Sol/Terra/Luna 반영, 2026-07-09 GA)
//   Google    — ai.google.dev/gemini-api/docs/pricing (Gemini 3.6 Flash 반영, 2026-07-21)
//   Anthropic — platform.claude.com (Claude Fable 5 반영, 2026-06-09)
...
export const PRICING = [
  // ── OpenAI (ChatGPT) ──
  { provider: 'OpenAI', name: 'GPT-5.6 Sol',    id: 'gpt-5.6-sol',    input: 5.00,  output: 30.00,  context: 1_000_000 },
  { provider: 'OpenAI', name: 'GPT-5.6 Terra',  id: 'gpt-5.6-terra',  input: 2.50,  output: 15.00,  context: 1_000_000 },
  { provider: 'OpenAI', name: 'GPT-5.6 Luna',   id: 'gpt-5.6-luna',   input: 1.00,  output: 6.00,   context: 1_000_000 },
  ...
  // ── Google (Gemini) ──
  { provider: 'Google', name: 'Gemini 3.6 Flash',      id: 'gemini-3.6-flash',       input: 1.50, output: 7.50,  context: 1_048_576 },

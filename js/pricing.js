...
// 기준일: 2026-08-24 (가격은 수시 변동 — 실제 청구 전 각 공식 페이지 재확인)
...
export const PRICING = [
  ...
  { provider: 'OpenAI', name: 'GPT-5.6 Terra',  id: 'gpt-5.6-terra',  input: 2.00,  output: 12.00, context: 1_050_000, tiered: { threshold: 272_000, input: 4.00, output: 18.00 } },
  { provider: 'OpenAI', name: 'GPT-5.6 Luna',   id: 'gpt-5.6-luna',   input: 0.20,  output: 1.20,  context: 1_050_000, tiered: { threshold: 272_000, input: 0.40, output: 1.80 } },
  { provider: 'OpenAI', name: 'GPT-5.5',        id: 'gpt-5.5',        input: 5.00,  output: 30.00,  context: 1_050_000, tiered: { threshold: 272_000, input: 10.00, output: 45.00 } },
  { provider: 'OpenAI', name: 'GPT-5.5 Pro',    id: 'gpt-5.5-pro',    input: 30.00, output: 180.00, context: 1_050_000 },
  { provider: 'OpenAI', name: 'GPT-5.4',        id: 'gpt-5.4',        input: 2.50,  output: 15.00,  context: 1_050_000, tiered: { threshold: 272_000, input: 5.00, output: 22.50 } },
  { provider: 'OpenAI', name: 'GPT-5.4 mini',   id: 'gpt-5.4-mini',   input: 0.75,  output: 4.50,   context: 400_000 },
  ...
  { provider: 'OpenAI', name: 'o3',             id: 'o3',             input: 2.00,  output: 8.00,   context: 200_000, status: 'deprecated' },
  { provider: 'OpenAI', name: 'o4-mini',        id: 'o4-mini',        input: 1.10,  output: 4.40,   context: 200_000, status: 'deprecated' },

  // ── Google (Gemini) ──
  { provider: 'Google', name: 'Gemini 3.7 Flash',      id: 'gemini-3.7-flash',       input: 0.75, output: 3.75, context: 1_048_576, effectiveUntil: '2026-12-31' },
  { provider: 'Google', name: 'Gemini 3.6 Flash',      id: 'gemini-3.6-flash',       input: 0.75, output: 3.75, context: 1_048_576, effectiveUntil: '2026-12-31' },
  { provider: 'Google', name: 'Gemini 3.5 Flash',      id: 'gemini-3.5-flash',       input: 1.50, output: 9.00,  context: 1_048_576 },
  { provider: 'Google', name: 'Gemini 3.1 Pro Preview', id: 'gemini-3.1-pro-preview', input: 2.00, output: 12.00, context: 1_048_576, status: 'preview', tiered: { threshold: 200_000, input: 4.00, output: 18.00 } },
  { provider: 'Google', name: 'Gemini 3.5 Flash-Lite', id: 'gemini-3.5-flash-lite',  input: 0.30, output: 2.50, context: 1_048_576 },
  { provider: 'Google', name: 'Gemini 3.1 Flash-Lite', id: 'gemini-3.1-flash-lite',  input: 0.25, output: 1.50,  context: 1_048_576, sunsetEarliest: '2027-05-07', replacement: 'gemini-3.5-flash-lite' },
  { provider: 'Google', name: 'Gemini 3 Flash Preview', id: 'gemini-3-flash-preview', input: 0.50, output: 3.00,  context: 1_048_576, status: 'preview' },
  ...
  // ── Anthropic (Claude) ──
  { provider: 'Anthropic', name: 'Claude Fable 5',    id: 'claude-fable-5',    input: 10.00, output: 50.00, context: 1_000_000 },
  { provider: 'Anthropic', name: 'Claude Opus 4.8',   id: 'claude-opus-4-8',   input: 5.00,  output: 25.00, context: 1_000_000 },
  { provider: 'Anthropic', name: 'Claude Opus 5',     id: 'claude-opus-5',     input: 5.00, output: 25.00, context: 1_000_000 },
  { provider: 'Anthropic', name: 'Claude Opus 4.7',   id: 'claude-opus-4-7',   input: 5.00, output: 25.00, context: 1_000_000 },
  { provider: 'Anthropic', name: 'Claude Sonnet 5',   id: 'claude-sonnet-5',   input: 2.00, output: 10.00, context: 1_000_000 },
